# -*- coding: utf-8 -*-
#------------------------------------------------------------
# http://www.youtube.com/user/10SecondTraumas
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "10SecondTraumas"

# Entry point
def run():
    plugintools.log("10SecondTraumas.run")
...
def main_list(params):
    plugintools.log("10SecondTraumas.main_list "+repr(params))
