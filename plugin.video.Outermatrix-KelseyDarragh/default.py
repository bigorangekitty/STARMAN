# -*- coding: utf-8 -*-
#------------------------------------------------------------
# http://www.youtube.com/user/KelseyDarragh
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "KelseyDarragh"

# Entry point
def run():
    plugintools.log("KelseyDarragh.run")
...
def main_list(params):
    plugintools.log("KelseyDarragh.main_list "+repr(params))
