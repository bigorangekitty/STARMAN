# -*- coding: utf-8 -*-
#------------------------------------------------------------
# http://www.youtube.com/user/bigorangekitty
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "bigorangekitty"

# Entry point
def run():
    plugintools.log("bigorangekitty.run")
...
def main_list(params):
    plugintools.log("Outermatrix.main_list "+repr(params))
