# -*- coding: utf-8 -*-
#------------------------------------------------------------
# http://www.youtube.com/user/lncredibleHuIk
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "lncredibleHuIk"

# Entry point
def run():
    plugintools.log("lncredibleHuIk.run")
...
def main_list(params):
    plugintools.log("lncredibleHuIk.main_list "+repr(params))
