# -*- coding: utf-8 -*-
#------------------------------------------------------------
# http://www.youtube.com/user/SpidermanTv9
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "SpidermanTv9"

# Entry point
def run():
    plugintools.log("SpidermanTv9.run")
...
def main_list(params):
    plugintools.log("SpidermanTv9.main_list "+repr(params))
